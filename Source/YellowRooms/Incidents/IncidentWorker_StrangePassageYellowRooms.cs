...
{
    public class IncidentWorker_StrangePassageYellowRooms : IncidentWorker
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            if (returnDoor != null && map.listerThings.ThingsOfDef(returnDoor).Any()) return false;
            if (portalFromRooms != null && map.listerThings.ThingsOfDef(portalFromRooms).Any()) return false;

            return FindSpawnCell(map).cell.IsValid;
        }
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            var doorDef = ThingDef.Named("YellowRooms_ReturnDoor");
            ...
            var letter = LetterMaker.MakeLetter("StrangePassageLabel".Translate(),
                "StrangePassageYellowDesc".Translate(), LetterDefOf.NeutralEvent, door);
